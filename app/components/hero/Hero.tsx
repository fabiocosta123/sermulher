        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          <div className="max-w-xl text-center lg:text-left">
            <h1 className="font-serif text-4xl font-normal leading-tight text-stone-900 sm:text-5xl lg:text-6xl">
              {/*  prop title que vem do banco */}
              {title || "Sua beleza em evidência"} <br />
              <span className="italic text-rose-600">melhor versão.</span>
            </h1>
          ...
          <div className="relative aspect-[4/5] overflow-hidden rounded-2xl bg-stone-200 shadow-2xl flex items-center justify-center">
            <span className="text-stone-400 italic">Espaço para imagem</span>
          </div>
        </div>
      </div>
    </section>
